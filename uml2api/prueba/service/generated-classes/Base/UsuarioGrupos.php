...
/**
 * Base class that represents a row from the 'Usuario_grupos' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class UsuarioGrupos implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UsuarioGruposTableMap';
    ...
    /**
     * Initializes internal state of Base\UsuarioGrupos object.
     */
    ...
    /**
     * Compares this with another <code>UsuarioGrupos</code> instance.  If
     * <code>obj</code> is an instance of <code>UsuarioGrupos</code>, delegates to
     * <code>equals(UsuarioGrupos)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UsuarioGrupos The current object, for fluid interface
     */
     ...
     * @return $this|\UsuarioGrupos The current object (for fluent API support)
     */
    public function setIdusuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[UsuarioGruposTableMap::COL_IDUSUARIO] = true;
        }
    ...
    public function setIdgrupo($v)
    {
        ...
        if ($this->idgrupo !== $v) {
            $this->idgrupo = $v;
            $this->modifiedColumns[UsuarioGruposTableMap::COL_IDGRUPO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UsuarioGruposTableMap::translateFieldName('Idusuario', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idusuario = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsuarioGruposTableMap::translateFieldName('Idgrupo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = UsuarioGruposTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UsuarioGrupos'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUsuarioGruposQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UsuarioGrupos::setDeleted()
     * @see UsuarioGrupos::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUsuarioGruposQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UsuarioGruposTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuarioGruposTableMap::COL_IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = 'idUsuario';
        }
        if ($this->isColumnModified(UsuarioGruposTableMap::COL_IDGRUPO)) {
            $modifiedColumns[':p' . $index++]  = 'idGrupo';
        }

        $sql = sprintf(
            'INSERT INTO Usuario_grupos (%s) VALUES (%s)',
    ...
    {
        $pos = UsuarioGruposTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UsuarioGrupos'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsuarioGrupos'][$this->hashCode()] = true;
        $keys = UsuarioGruposTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioGruposTableMap::COL_IDUSUARIO)) {
            $criteria->add(UsuarioGruposTableMap::COL_IDUSUARIO, $this->idusuario);
        }
        if ($this->isColumnModified(UsuarioGruposTableMap::COL_IDGRUPO)) {
            $criteria->add(UsuarioGruposTableMap::COL_IDGRUPO, $this->idgrupo);
        }
    ...
    {
        $criteria = ChildUsuarioGruposQuery::create();
        $criteria->add(UsuarioGruposTableMap::COL_IDUSUARIO, $this->idusuario);
        $criteria->add(UsuarioGruposTableMap::COL_IDGRUPO, $this->idgrupo);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getIdusuario() &&
            null !== $this->getIdgrupo();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation Usuario_grupos to table Usuario
        ...
        //relation idGrupo_Usuario to table Grupo
    ...
    {
        return (null === $this->getIdusuario()) && (null === $this->getIdgrupo());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UsuarioGrupos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UsuarioGrupos Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUsuario(ConnectionInterface $con = null)
    {
        if ($this->aUsuario === null && (($this->idusuario !== "" && $this->idusuario !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuario->addUsuarioGruposs($this);
             */
        }
    ...
    public function getGrupo(ConnectionInterface $con = null)
    {
        if ($this->aGrupo === null && ($this->idgrupo !== null)) {
            $this->aGrupo = ChildGrupoQuery::create()->findPk($this->idgrupo, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGrupo->addUsuarioGruposs($this);
             */
        }
    ...
    {
        if (null !== $this->aUsuario) {
            $this->aUsuario->removeUsuarioGrupos($this);
        }
        if (null !== $this->aGrupo) {
            $this->aGrupo->removeUsuarioGrupos($this);
        }
        $this->idusuario = null;
        $this->idgrupo = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(UsuarioGruposTableMap::DEFAULT_STRING_FORMAT);
    }
