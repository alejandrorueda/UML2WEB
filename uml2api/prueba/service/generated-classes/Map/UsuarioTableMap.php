...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_FKPERFIL = 'Usuario.fkperfil';

    /**
     * the column name for the descendant_class field
     */
    const COL_DESCENDANT_CLASS = 'Usuario.descendant_class';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idusuario', 'Password', 'Email', 'Avatar', 'Nombre', 'Apellidos', 'Fkperfil', 'DescendantClass', ),
        self::TYPE_CAMELNAME     => array('idusuario', 'password', 'email', 'avatar', 'nombre', 'apellidos', 'fkperfil', 'descendantClass', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_IDUSUARIO, UsuarioTableMap::COL_PASSWORD, UsuarioTableMap::COL_EMAIL, UsuarioTableMap::COL_AVATAR, UsuarioTableMap::COL_NOMBRE, UsuarioTableMap::COL_APELLIDOS, UsuarioTableMap::COL_FKPERFIL, UsuarioTableMap::COL_DESCENDANT_CLASS, ),
        self::TYPE_FIELDNAME     => array('idusuario', 'password', 'email', 'avatar', 'nombre', 'apellidos', 'fkperfil', 'descendant_class', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idusuario' => 0, 'Password' => 1, 'Email' => 2, 'Avatar' => 3, 'Nombre' => 4, 'Apellidos' => 5, 'Fkperfil' => 6, 'DescendantClass' => 7, ),
        self::TYPE_CAMELNAME     => array('idusuario' => 0, 'password' => 1, 'email' => 2, 'avatar' => 3, 'nombre' => 4, 'apellidos' => 5, 'fkperfil' => 6, 'descendantClass' => 7, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_IDUSUARIO => 0, UsuarioTableMap::COL_PASSWORD => 1, UsuarioTableMap::COL_EMAIL => 2, UsuarioTableMap::COL_AVATAR => 3, UsuarioTableMap::COL_NOMBRE => 4, UsuarioTableMap::COL_APELLIDOS => 5, UsuarioTableMap::COL_FKPERFIL => 6, UsuarioTableMap::COL_DESCENDANT_CLASS => 7, ),
        self::TYPE_FIELDNAME     => array('idusuario' => 0, 'password' => 1, 'email' => 2, 'avatar' => 3, 'nombre' => 4, 'apellidos' => 5, 'fkperfil' => 6, 'descendant_class' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('idusuario', 'Idusuario', 'VARCHAR', true, 50, null);
  ...
  array (
    ...
    1 => ':idPerfil',
        ...
        $this->addRelation('AmigosRelatedByIdusuario', '\\Amigos', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idUsuario',
    1 => ':idusuario',
  ),
), null, null, 'AmigossRelatedByIdusuario', false);
        $this->addRelation('AmigosRelatedByRelacionusuario', '\\Amigos', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':relacionusuario',
    1 => ':idusuario',
  ),
), null, null, 'AmigossRelatedByRelacionusuario', false);
  ...
  array (
    ...
    1 => ':idusuario',
        ...
        $this->addRelation('UsuarioGrupos', '\\UsuarioGrupos', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idUsuario',
    1 => ':idusuario',
  ),
), null, null, 'UsuarioGruposs', false);
  ...
  array (
    ...
    1 => ':idusuario',
        ...
        $this->addRelation('Administrador', '\\Administrador', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idusuario',
    1 => ':idusuario',
  ),
), 'CASCADE', null, 'Administradors', false);
  ...
  array (
...
), 'CASCADE', null, 'Colaboradors', false);
        $this->addRelation('UsuarioRelatedByRelacionusuario', '\\Usuario', RelationMap::MANY_TO_MANY, array(), null, null, 'UsuariosRelatedByRelacionusuario');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_FKPERFIL);
            $criteria->addSelectColumn(UsuarioTableMap::COL_DESCENDANT_CLASS);
        } else {
