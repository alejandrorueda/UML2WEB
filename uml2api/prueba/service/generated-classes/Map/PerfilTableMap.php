...
class PerfilTableMap extends TableMap
{
     ...
     */
    const COL_INFORMACION = 'Perfil.informacion';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idperfil', 'Informacion', 'Nacimiento', 'Gustos', ),
        self::TYPE_CAMELNAME     => array('idperfil', 'informacion', 'nacimiento', 'gustos', ),
        self::TYPE_COLNAME       => array(PerfilTableMap::COL_IDPERFIL, PerfilTableMap::COL_INFORMACION, PerfilTableMap::COL_NACIMIENTO, PerfilTableMap::COL_GUSTOS, ),
        self::TYPE_FIELDNAME     => array('idPerfil', 'informacion', 'nacimiento', 'gustos', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idperfil' => 0, 'Informacion' => 1, 'Nacimiento' => 2, 'Gustos' => 3, ),
        self::TYPE_CAMELNAME     => array('idperfil' => 0, 'informacion' => 1, 'nacimiento' => 2, 'gustos' => 3, ),
        self::TYPE_COLNAME       => array(PerfilTableMap::COL_IDPERFIL => 0, PerfilTableMap::COL_INFORMACION => 1, PerfilTableMap::COL_NACIMIENTO => 2, PerfilTableMap::COL_GUSTOS => 3, ),
        self::TYPE_FIELDNAME     => array('idPerfil' => 0, 'informacion' => 1, 'nacimiento' => 2, 'gustos' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('gustos', 'Gustos', 'VARCHAR', true, 1, null);
    } // initialize()
...
), null, null, 'Administradors', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PerfilTableMap::COL_INFORMACION);
