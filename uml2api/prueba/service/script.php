...
switch ($type) {
      ...
      case "addUsuarioViajes":
        ...
        break;
      case "deleteUsuarioViajes":
      	$usuario = new Usuario();
          $usuario = $usuario->get($_POST["idelement"]);
          check($usuario->deleteViajeMany($_POST["idViaje"]));
        break;
      case "getUsuarioListUsuarios":
      	$usuario = new Usuario();
          $usuario = $usuario->get($_GET["idelement"]);
          $query = $usuario->getUsuariosRelatedByRelacionusuario();
          ArrayEcho($query);
        break;
      case "addUsuarioListUsuarios":
        ...
        break;
       case "deleteUsuarioListUsuarios":
      	$usuario = new Usuario();
          $usuario = $usuario->get($_POST["idelement"]);
          check(!$usuario->deleteAmigos($_POST["idusuario"]));
        break;
      ...
      case "addUsuarioGrupos":
        ...
        break;
      case "deleteUsuarioGrupos":
      	$usuario = new Usuario();
          $usuario = $usuario->get($_POST["idelement"]);
          check($usuario->deleteGrupoMany($_POST["idGrupo"]));
        break;
      ...
      case "addGrupoViajes":
        ...
        break;
      case "deleteGrupoViajes":
      	$grupo = new Grupo();
          $grupo = $grupo->get($_POST["idelement"]);
          check($grupo->deleteViajeMany($_POST["idViaje"]));
        break;
      ...
      case "addGrupoUsuarios":
        ...
        break;
      case "deleteGrupoUsuarios":
      	$grupo = new Grupo();
          $grupo = $grupo->get($_POST["idelement"]);
          check($grupo->deleteUsuarioMany($_POST["idusuario"]));
        break;
      ...
      case "addViajeUsuarios":
        ...
        break;
      case "deleteViajeUsuarios":
      	$viaje = new Viaje();
          $viaje = $viaje->get($_POST["idelement"]);
          check($viaje->deleteUsuarioMany($_POST["idusuario"]));
        break;
      case "getViajeGrupos":
      	$viaje = new Viaje();
          $viaje = $viaje->get($_GET["idelement"]);
      ...
      case "addViajeGrupos":
        ...
        break;
      case "deleteViajeGrupos":
      	$viaje = new Viaje();
          $viaje = $viaje->get($_POST["idelement"]);
          check($viaje->deleteGrupoMany($_POST["idGrupo"]));
        break;
      ...
      case "addAdministrador":
          $administrador = new Administrador();
  		  if(!$administrador->add($_POST["idusuario"])){
              echo json_encode(["success"=> false] );
  		  }
  		 else{
             echo json_encode(["success"=> true] );
  	...
  	case "getAdministrador":
          $administrador = new Administrador();
  		 echo $administrador->get($_GET["idusuario"])->toJSON();
          break;
  	...
  	case "deleteAdministrador":
          $administrador = new Administrador();
  		 check($administrador->normalDelete($_POST["idusuario"]));
          break;
  	case "updateAdministrador":
          $administrador = new Administrador();
          $administrador = $administrador->get($_POST["idusuario"]);
  		check($administrador->add($_POST["idusuario"]));
          break;
